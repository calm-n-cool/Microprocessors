This folder contains the code for the Electronic Voting Machine programmed on a FPGA. It also contains the constraint file, the segment module used and the test bench.
